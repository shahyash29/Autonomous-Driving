...
train_mean_channels = pickle.load(open("segmentation/data/mean_channels.pkl","rb"))

# load the sequence data:
seq_frames_dir = "data/cityscapes/leftImg8bit/train/stuttgart/"
seq_frame_paths = []
...
with tf.compat.v1.Session() as sess:
    ...
    saver.restore(sess,"training_logs/best_model/model_1_epoch_23.ckpt")
